...
Transcribed verbatim from the original grafana-dashboard.json (panel indices 29-48).
"""
...
panels = [
    ...
    },
    {
        ...
        "options": {
            ...
            '  <td style="text-align: center;vertical-align: middle;border:0px solid '
            'black; "><p style="font-weight: bold;">$instances</p>\n'
            "  </td>\n"
            "</table>",
            "mode": "html",
        },
    ...
    {
        "datasource": {"type": "prometheus", "uid": "${DS_PROMETHEUS}"},
        "description": "This metric depends on exporting the: `topology.kubernetes.io/zone` label "
        "through kube-state-metrics (not enabled by default). Can be added by changing "
        ...
        "targets": [
            {
                ...
                "editorMode": "code",
                "exemplar": True,
                "expr": '100 * sum by (pod) (cnpg_backends_total{namespace=~"$namespace", '
        ...
        "targets": [
            {
                ...
                "editorMode": "code",
                "exemplar": False,
                "expr": 'cnpg_collector_postgres_version{namespace=~"$namespace", '
                'pod=~"$instances"}',
                "format": "table",
                "hide": False,
                "instant": True,
