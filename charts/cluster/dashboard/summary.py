...
Transcribed verbatim from the original grafana-dashboard.json (panel indices 0-28).
"""
...
panels = [
    ...
    {
        "datasource": {"type": "prometheus", "uid": "${DS_PROMETHEUS}"},
        "description": "Cluster Replication Health represents the availability of replica servers "
        "available to replace the primary in case of a failure.",
        "fieldConfig": {
            "defaults": {
    ...
    {
        "datasource": {"type": "prometheus", "uid": "${DS_PROMETHEUS}"},
        "description": "High lag indicates issue with replication. Network or storage interfaces may not "
        "have enough bandwidth to handle incoming traffic and replication at the same "
        "time.",
        "fieldConfig": {
            "defaults": {
                "color": {"mode": "thresholds"},
                "mappings": [
                    {
                        "options": {
                            "match": "null",
                            "result": {"color": "text", "index": 0, "text": "No data"},
                        },
                        "type": "special",
                    },
                    {
                        "options": {
                            "from": 0,
                            "result": {"color": "green", "index": 1, "text": "Healthy"},
                            "to": 0.1,
                        },
                        "type": "range",
                    },
            ...
            "defaults": {
                ...
                "mappings": [
                    ...
                    },
                    {
                        "options": {
                            "from": 0.9,
                            "result": {"color": "red", "index": 3, "text": "Critical"},
                            "to": 0.98,
                        },
                        "type": "range",
                    },
                    {
                        "options": {
                            "from": 0.98,
                            "result": {"color": "red", "index": 4, "text": "Data Loss"},
                            "to": 1,
                        },
                        "type": "range",
                    },
        ...
        "targets": [
            {
                ...
                "exemplar": False,
                "expr": "-(time() - "
                'max(cnpg_collector_last_available_backup_timestamp{namespace="$namespace",pod=~"$instances"}))',
                "instant": True,
                "legendFormat": "__auto",
                "range": False,
                "refId": "A",
    ...
    },
    {
        ...
        "We ensure to ignore the metric in the replicas by using (1 - "
        "cnpg_pg_replication_in_recovery ) as a multiplicative factor. It will be 0 for "
        "replicas, 1 for the primary.",
        "fieldConfig": {
            "defaults": {
                "color": {"mode": "thresholds"},
                "mappings": [
                    ...
                    },
                    {
                        "options": {
                            "from": -1e22,
                            "result": {"color": "text", "index": 1, "text": "No data"},
                            "to": 0,
                        },
                        "type": "range",
                    },
    ...
    {
        "datasource": {"type": "prometheus", "uid": "${DS_PROMETHEUS}"},
        "description": "Base Backups are considered healthy when there has been at least one base backup "
                ...
                "mappings": [
                    {
                        "options": {
                            "match": "null",
                            "result": {"color": "orange", "index": 0, "text": "None"},
                        },
                        "type": "special",
                    },
                    {
        ...
        "targets": [
            {
                ...
                "editorMode": "code",
                "expr": "time() - "
                'max(cnpg_collector_last_available_backup_timestamp{namespace="$namespace", '
                'pod=~"$instances"})',
    ...
    {
        "datasource": {"type": "prometheus", "uid": "${DS_PROMETHEUS}"},
        "description": "WAL is considered Healthy when the last WAL is 0min to 6min old, Delayed when it "
        "is less than 15min and Unsynced for >15min.",
        "fieldConfig": {
            "defaults": {
                "color": {"mode": "thresholds"},
                "mappings": [
                    ...
                    },
                    {
                        "options": {
                            "from": 900,
                            "result": {"color": "red", "index": 3, "text": "Unsynced"},
                            "to": 4294967295,
                        },
                        "type": "range",
                    },
            ...
            "defaults": {
                ...
                "mappings": [
                    ...
                    },
                    {
                        "options": {
                            "from": 1,
                            "result": {"color": "green", "index": 1, "text": "Online"},
                            "to": 99,
                        },
                        "type": "range",
                    },
            ...
            "overrides": [
                {
                    ...
                    "properties": [{"id": "displayName", "value": "Reconcile errors"}],
                }
            ],
        },
        "gridPos": {"h": 2, "w": 1, "x": 5, "y": 5},
        "id": 589,
        "options": {
            "colorMode": "background",
            "graphMode": "none",
    ...
    {
        "datasource": {"type": "prometheus", "uid": "${DS_PROMETHEUS}"},
        "description": "The operator reconcile errors don't distinguish between database cluster or "
        "namespaces.",
        "fieldConfig": {
            "defaults": {
                "color": {"mode": "thresholds"},
                "mappings": [
                    ...
                    },
                    {
                        "options": {
                            "from": 1,
                            "result": {"color": "red", "index": 1, "text": "Backup"},
                            "to": 9,
                        },
                        "type": "range",
                    },
                    {
                        "options": {
                            "from": 10,
                            "result": {"color": "red", "index": 2, "text": "Cluster"},
                            "to": 99,
                        },
                        "type": "range",
                    },
                    {
                        "options": {
                            "from": 100,
                            "result": {"color": "red", "index": 3, "text": "Pooler"},
                            "to": 999,
                        },
                        "type": "range",
                    },
    ...
    },
    {
        ...
        "fieldConfig": {
            "defaults": {
                ...
                "mappings": [
                    {
                        "options": {"0": {"color": "red", "index": 1, "text": "N/A"}},
                        "type": "value",
                    },
                    {
                        "options": {
